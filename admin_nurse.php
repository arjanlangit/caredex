                    ...
                    <ul class="navbar-nav ml-auto ">
                        <li class="nav-item pr-3">
                          ...
                          <li class="nav-item dropdown pr-3 no-arrow">
                            <a class="nav-link dropdown-toggle waves-effect waves-light pl-5 pr-5" id="agents-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-clock"></i> Patient
                            </a>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <tbody>
                                        ...
                                        ?>    
                                            <tr>
                                                   <td class="wo-button"><?php echo $row["userID"]; ?></td>
                                                    <td class="wo-button"><a class="view-agent font-weight-bold " style="cursor:default"><?php echo $row["f_name"] . " " . $row["l_name"];?></a></td>
                                                    <td class="wo-button"><?php echo $row["title"];?></td>
                                                  <td class="wo-button"><?php echo $row["user"];?></td>
                                                    <td class="wo-button"><?php echo $row["age"];?></td>
                                                    <td class="wo-button"><?php echo $row["sex"];?></td>
                                                    <td class="with-button">
                                                        
                                                        
                                                        <button id='btn_delete' data-id3="<?php echo $row['userID'];?>" class="material-tooltip-main red-text font-weight-bold" data-toggle="tooltip" onclick="delete1()" data-placement="right" title="View Patient Information"> DELETE</button>
                                                        
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 

                                                        
                                                        <a href="admin_view_individual_nurse.php?id=<?php echo $row['userID'];?>" ><button class="material-tooltip-main blue-text font-weight-bold" data-toggle="tooltip"  data-placement="right" title="View Patient Information"> VIEW</button></a>
...
<script>
    ...
    var p_id=$(this).data("id3");
       if(confirm("Are you sure you want to Delete this record? ID number: "+p_id+" "))
		...
		$.ajax({
			url:"delete_data_nurse.php",
			method:"POST",
			data:{ p_id:p_id},
			dataType:"text",
			success: function (data){
           
          alert("Nurse ID number:  "+p_id+"  deleted successfully!");      
		window.location = "admin_nurse.php";
